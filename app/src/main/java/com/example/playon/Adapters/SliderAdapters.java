package com.example.playon.Adapters;
...
import com.example.playon.Activities.MainActivity;
...
public class SliderAdapters extends RecyclerView.Adapter<SliderAdapters.SliderViewHolder> {
    ...
    public SliderAdapters(List<SliderItems> sliderItems, ViewPager2 viewPager2, MainActivity mainActivity) {
