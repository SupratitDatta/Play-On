...
import com.example.playon.Adapters.ActorsListAdapters;
import com.example.playon.Adapters.CategoryEachFilmListAdapter;
import com.example.playon.Domains.FilmItem;
    ...
    private void sendRequest() {
        ...
        mStringRequest = new StringRequest(Request.Method.GET, "https://moviesapi.ir/api/v1/movies/" + idFilm, response -> {
            ...
            if(item.getImages() != null){
                adapterActorList = new ActorsListAdapters(item.getImages());
